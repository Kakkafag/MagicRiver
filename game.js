...
const imagePaths = {
  scene: 'assets/images/river_scene.png',
  animals: 'assets/images/animals.png'
};
const soundPaths = {
  music: 'assets/sounds/pixel_hunt_rush.ogg',
  shot: 'assets/sounds/gunshot_pro.ogg',
  DUCK: 'assets/sounds/duck.ogg',
  FISH: 'assets/sounds/splat.ogg',
  DEER: 'assets/sounds/moose.ogg',
  BEAVER: 'assets/sounds/squeek.ogg',
  GOLDEN_PLATYPUS: 'assets/sounds/victory.ogg'
};
